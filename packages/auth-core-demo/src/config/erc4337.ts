export const options = {
    BICONOMY_V1: {
        ...
        SUPPORTED_CHAIN_IDS: [1, 5, 137, 80002, 56, 97, 42161, 42170, 10, 43114, 43113, 8453, 1101, 59140],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
    BICONOMY_V2: {
    ...
    SIMPLE: {
        ...
        SUPPORTED_CHAIN_IDS: [
            ...
            7000, 7001, 1116, 1115, 34443, 919, 888888888, 28122024, 81457, 168587773, 80085, 112358, 1637450,
            202402181627, 13473, 2241, 9990, 7560, 111557560, 1224,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
