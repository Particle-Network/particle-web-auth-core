export const options = {
    ...
    SIMPLE: {
        NAME: 'Simple Account',
        SUPPORTED_CHAIN_IDS: [
            1, 5, 11155111, 17000, 137, 80001, 80002, 56, 97, 204, 5611, 42161, 42170, 421613, 421614, 43114, 43113,
            8453, 84531, 84532, 59144, 59140, 10, 420, 11155420, 169, 3441005, 5000, 5003, 534352, 534351, 100, 10200,
            424, 58008, 88, 89, 1284, 1285, 1287, 1101, 1442, 250, 4002, 9980, 91715, 42766, 43851, 167008, 195, 3776,
            6038361, 12008, 12015, 7000, 7001, 1116, 1115, 34443, 919, 888888888, 28122024, 81457, 168587773, 80085,
            112358, 1637450, 202402181627, 13473,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
    ...
    BTC: {
        NAME: 'BTC Account',
        SUPPORTED_CHAIN_IDS: [4200, 686868, 28206, 11503, 1501, 1502, 22776, 212, 3110, 80001],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
    BTC_V2: {
