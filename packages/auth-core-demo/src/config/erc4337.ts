export const options = {
    BICONOMY_V1: {
        ...
        SUPPORTED_CHAIN_IDS: [
            1, 5, 137, 80002, 56, 97, 42161, 42170, 421613, 10, 420, 43114, 43113, 8453, 84531, 1101, 59140,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
    BICONOMY_V2: {
        ...
        SUPPORTED_CHAIN_IDS: [
            1, 11155111, 137, 56, 97, 42161, 42170, 421614, 10, 11155420, 43114, 43113, 8453, 84532, 1101, 2442, 59144,
            204, 5611, 5000, 5003, 169, 3441005, 9980, 1284, 534352, 534351, 81457, 168587773, 196, 195, 100, 10200,
            7000, 7001, 80085,
        ],
        BATCH_TX: true,
        VERSION: '2.0.0',
    ...
    SIMPLE: {
        NAME: 'Simple Account',
        SUPPORTED_CHAIN_IDS: [
            1, 11155111, 17000, 137, 80002, 56, 97, 204, 5611, 42161, 42170, 421613, 421614, 43114, 43113, 8453, 84531,
            84532, 59144, 59140, 59141, 10, 420, 11155420, 169, 3441005, 5000, 5003, 534352, 534351, 100, 10200, 424,
    ...
    BTC: {
        NAME: 'BTC Account',
        SUPPORTED_CHAIN_IDS: [
            4200, 686868, 28206, 11503, 1501, 1502, 22776, 212, 3110, 1, 11155111, 137, 200901, 200810,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
    ...
    UNIVERSAL: {
        ...
        SUPPORTED_CHAIN_IDS: [11155111, 2011, 11155420, 80002, 421614, 84532, 59141, 168587773, 97, 43113, 1123],
        BATCH_TX: true,
        VERSION: '1.0.0',
    },
    XTERIO: {
