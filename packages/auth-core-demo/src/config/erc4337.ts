...
export const options = {
    ...
    SIMPLE_V1: {
        ...
        SUPPORTED_CHAIN_IDS: [
            ...
            59141, 10, 11155420, 169, 3441006, 5000, 5003, 534352, 534351, 100, 10200, 424, 58008, 88, 89, 1284, 1285,
            1287, 1101, 250, 4002, 9980, 1715, 42766, 43851, 167000, 167009, 196, 195, 3776, 6038361, 12008, 12015,
            7000, 7001, 1116, 1115, 34443, 919, 888888888, 28122024, 81457, 168587773, 80084, 112358, 1637450, 2777,
            202402181627, 13473, 2241, 9990, 7560, 111557560, 1225, 200901, 200810, 122, 123, 4689, 4690, 1329, 1328,
            713715,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
