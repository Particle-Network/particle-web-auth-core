...
export const options = {
    ...
    BICONOMY_V2: {
        ...
        SUPPORTED_CHAIN_IDS: [
            ...
            59144, 204, 5611, 5000, 5003, 169, 9980, 1284, 534352, 534351, 81457, 168587773, 196, 195, 100, 10200, 7000,
            7001,
        ],
        BATCH_TX: true,
        VERSION: '2.0.0',
    ...
    SIMPLE_V1: {
        ...
        SUPPORTED_CHAIN_IDS: [
            ...
            59141, 10, 11155420, 169, 3441006, 5000, 5003, 534352, 534351, 100, 10200, 88, 89, 1284, 1285, 1287, 1101,
            250, 4002, 9980, 1715, 42766, 43851, 167000, 167009, 196, 195, 3776, 6038361, 12008, 12015, 7000, 7001,
            1116, 1115, 34443, 919, 888888888, 28122024, 81457, 168587773, 80084, 112358, 1637450, 2777, 202402181627,
            13473, 2241, 9990, 7560, 111557560, 1225, 200901, 200810, 122, 123, 4689, 4690, 1329, 1328, 713715, 48899,
            1802203764,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
    ...
    BTC: {
        ...
        SUPPORTED_CHAIN_IDS: [
            ...
            83291, 1116, 1115, 3636, 89682, 1, 11155111, 137, 80002, 2442, 56, 97, 42161, 421614, 5000, 5003, 2649,
            2648,
        ],
        BATCH_TX: true,
        VERSION: '1.0.0',
